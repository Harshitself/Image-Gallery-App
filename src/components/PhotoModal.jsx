  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="photo-modal z-50 p-4 bg-white rounded-lg shadow-lg relative">
        <span className="close absolute top-2 right-2 text-red-600 text-2xl cursor-pointer" onClick={onCloseModal}>
          &times;
        </span>
        <img src={selectedPhoto.urls.regular} alt={selectedPhoto.description} className="max-h-96 w-full" />
        <div className="modal-info mt-4 text-center">
          ...
          <p className="text-gray-600">Instagram: {selectedPhoto.user.instagram_username}</p>
        ...
        {/* Add more details and features as needed */}
      </div>
    </div>
    );
}
